...
<ul class="bxslider1">
	...
	<li><img src="resources/images/slide2.jpg"></a></li>
    <li><img src="resources/images/slide4.jpg"></a></li>
</ul> 	
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="resources/assets/img/portfolio/cabin.png" alt="" />  <!-- 썸네일 -->
                        </div>
                    </div>
                    <!-- Portfolio Item 2-->
                    <div class="col-md-6 col-lg-4 mb-5">
